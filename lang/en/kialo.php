...
$string['errors:missingdiscussionurl'] = "Missing discussion url";
...
$string['errors:updaterecordfailed'] = "Failed to update kialo record";
...
// These strings define labels for the new weekly debates page.  The
// "debatesweek" string names the section itself, while the
// "noactivedebates" string is shown when there are no debates to list.
$string['debatesweek'] = 'Debates of the week';
$string['noactivedebates'] = 'No active debates at the moment.';
